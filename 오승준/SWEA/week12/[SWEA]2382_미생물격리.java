...
// 배열에 겹치는 경우와 미생물의 수를 같이 써야돼
// 한꺼번에 넣을 수 없으니까 class로 만들어서 같이 꺼낼 수 있게 한다
// 배열에는 idx만 넣어서 미생물을 구분할 수 있게 함!
class micro {
	int idx;
	int num;
	int dir;
